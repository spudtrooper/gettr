...
// genopts --opt_type=UserPostsOption --prefix=UserPosts --outfile=model/userpostsoptions.go 'offset:int' 'max:int' 'incl:[]string' 'start:int' 'threads:int' 'fromDisk' 'force'
