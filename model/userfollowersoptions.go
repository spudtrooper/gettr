...
//go:generate genopts --opt_type=UserFollowersOption --prefix=UserFollowers --outfile=userfollowersoptions.go "offset:int" "max:int" "incl:[]string" "start:int" "threads:int" "fromDisk" "force"
