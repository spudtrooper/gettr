...
//go:generate genopts --opt_type=RequestOption --prefix=Request --outfile=api/requestoptions.go "extraHeaders:map[string]string" "host:string" "customPayload:interface{}"
